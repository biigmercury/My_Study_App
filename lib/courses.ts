...
export const COURSES: Course[] = [
  ...
  },
  {
    ...
    creditHours: 3,
    description: 'Solution methods for linear ordinary differential equations: undetermined coefficients, D-operator, variation of parameters, and systems via eigenvalues.',
    accent: 'linear-gradient(135deg, #0e7490, #67e8f9)',
    accentFrom: '#0e7490',
    accentTo: '#67e8f9',
    icon: '∫',
    topics: [
      { slug: 'undetermined-coefficients', title: 'Method of Undetermined Coefficients', duration: '50 min', difficulty: 'intermediate' },
      { slug: 'operator-method', title: 'The D-Operator Method', duration: '55 min', difficulty: 'advanced' },
      { slug: 'variation-of-parameters', title: 'Variation of Parameters', duration: '45 min', difficulty: 'advanced' },
      { slug: 'systems-of-odes-eigenvalue-method', title: 'Systems of ODEs: Eigenvalue Method', duration: '60 min', difficulty: 'advanced' },
    ],
  },
  {
    code: 'csc203',
