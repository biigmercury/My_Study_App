...
**Drawing the K-map** (rows = AB in Gray code, columns = C):
...
**Group 1 — the C=1 column, top two cells (AB=00 and AB=01):**
- A is always 0 → $\overline{A}$
- B changes (0 then 1) → drops out
- C is always 1 → $C$
- Term: $\overline{A}C$

**Group 2 — the AB=11 row and AB=10,C=0 (the bottom-left 4-cell block AB=11,10 with appropriate cells):**

Let me regroup carefully. The 1s are at: (00,1), (01,1), (11,0), (11,1), (10,0).

**Group A:** AB=01,C=1 and AB=11,C=1 and AB=00,C=1 and ... let me take the right column top half + the AB=11 cells.

- **Group 1:** Right column, AB=00 and AB=01 → $\overline{A}C$
- **Group 2:** AB=11 row (both C=0 and C=1) → $AB$
- **Group 3:** Left column AB=11 and AB=10 (C=0) → $A\overline{C}$
...
**K-map** (rows = AB, columns = CD, both Gray code):
...
AB=00   |  1   |  0   |  1   |  0   |
AB=01   |  0   |  1   |  1   |  0   |
AB=11   |  X   |  X   |  X   |  X   |   ← don't cares (10-15)
AB=10   |  1   |  0   |  X   |  X   |
```
