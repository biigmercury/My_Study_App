...
In an experiment:
- One variable is **deliberately manipulated** — this is the **independent variable** (IV)
- Another variable is **observed and measured** — this is the **dependent variable** (DV)
