...
export default function TakeawayBlock({ children }: TakeawayBlockProps) {
  return (
    <div className="my-8 rounded-2xl p-px bg-brand-gradient">
      <div className="rounded-2xl bg-brand-frost dark:bg-brand-slate p-5">
        <div className="flex items-center gap-2 mb-3">
          <span className="text-lg">⭐</span>
          <h4 className="font-bold text-brand-ocean dark:text-brand-cyan text-base">Key Takeaway</h4>
        </div>
